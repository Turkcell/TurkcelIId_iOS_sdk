...
extern NSString * const TLUICKeyChainStoreErrorDomain;
...
@interface TLUICKeyChainStore : NSObject
...
+ (TLUICKeyChainStore *)keyChainStore;
+ (TLUICKeyChainStore *)keyChainStoreWithService:(NSString *)service;
+ (TLUICKeyChainStore *)keyChainStoreWithService:(NSString *)service accessGroup:(NSString *)accessGroup;

+ (TLUICKeyChainStore *)keyChainStoreWithServer:(NSURL *)server protocolType:(UICKeyChainStoreProtocolType)protocolType;
+ (TLUICKeyChainStore *)keyChainStoreWithServer:(NSURL *)server protocolType:(UICKeyChainStoreProtocolType)protocolType authenticationType:(UICKeyChainStoreAuthenticationType)authenticationType;
