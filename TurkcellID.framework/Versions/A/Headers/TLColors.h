...
#define T_VERY_DARK_BLUE                    UIColorFromRGB(0x0f052b)
#define T_BLUE                              UIColorFromRGB(0x03A0E7)
#define T_GRAY_2                            UIColorFromRGB(0xE6E6E8)
#define T_GRAY                              UIColorFromRGB(0xBAB9BD)
#define T_DARK_BLUE                         UIColorFromRGB(0x111F3F)
